const Header = () => {
    return (
        <header className="relative flex items-center justify-between px-8 py-5 bg-linear-to-r from-[#4A3F71] to-[#5E507F] z-10">
            ...
            <div className="flex items-center relative">
                ...
                <span className="font-bold text-white text-xl tracking-tight">Ask AI</span>
            </div>
