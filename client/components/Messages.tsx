                ...
                {searchInfo.stages.includes('searching') && (
                    <div className="relative">
                        ...
                        {searchInfo.stages.includes('reading') && (
                            <div className="absolute -left-[7px] top-3 w-0.5 h-[calc(100%+1rem)] bg-linear-to-b from-teal-300 to-teal-200"></div>
                        )}
                        ...
                        <div className="flex flex-col max-w-md">
                            ...
                            <div
                                className={`rounded-lg py-3 px-5 ${message.isUser
                                    ? 'bg-linear-to-br from-[#5E507F] to-[#4A3F71] text-white rounded-br-none shadow-md'
